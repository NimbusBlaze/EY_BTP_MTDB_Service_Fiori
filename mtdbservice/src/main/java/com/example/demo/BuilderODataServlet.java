...
, initParams = {
		...
		@WebInitParam(name = "org.apache.olingo.odata2.service.factory", value = "com.example.demo.processor.MyODataProcessor") 
		}
...
public class BuilderODataServlet extends ODataServlet {
	...
	private String oDataServiceFactoryBeanName = "com.example.demo.processor.MyODataServiceFactory";
