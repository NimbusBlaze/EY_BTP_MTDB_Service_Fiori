...
//		log.debug("MyODataAnnotationDs writeRelation called");
		ODataInterface oDataInterface = this.getODataInterfaceByName(this.getODataBeanAgentName(targetEntitySet));
		oDataInterface.writeRelation(sourceEntitySet, sourceData, targetEntitySet, targetKeys);
	}
